...
- Las reglas de Firestore para Asignaciones deben permitir programas asignados en `usuarios.assignedPrograms`, programas donde `programas.coordinator` coincida con el usuario activo y equivalencias ya validadas por la interfaz; tambien deben bloquear edicion de Coordinacion Academica sobre asignaciones creadas por otros usuarios.
